...
function Snake(pos, len)
{
  ...
  this.SnackMove = function() // сдвинуть еду
  {
  ...
  this.MoveYourself = function(nextPos)  // сдвинуть змею
  {
  ...
  this.GetNextPosition = function() // получение следующей позиции
  {
  ...
  this.DevideYourself = function(a) // разделить себя
  {
    //create snake
  }
  
  this.Die = function() // проиграть)
  {
    this.alive = false;
  }
}
